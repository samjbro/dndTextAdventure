module Mini_Actions
	...
	def Mini_Actions.look(player, direction="around")
		...
		north = $maps[$current_map]["@map_tiles"][[x_current,y_current+1]]
		east =	$maps[$current_map]["@map_tiles"][[x_current+1,y_current]]
		south = $maps[$current_map]["@map_tiles"][[x_current,y_current-1]]
		west = $maps[$current_map]["@map_tiles"][[x_current-1,y_current]]
		case direction
		when "n", "north"
